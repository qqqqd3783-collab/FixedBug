...
local EventTab2 = Window:Tab("Event 2", "rbxassetid://128706247346129")
...
local function PressAndVerifyXP(rootPart)
    ...
    -- [!! แก้ไข !!] เปลี่ยนเป็น FindFirstChild แบบปลอดภัย
    local ProximityPrompts = LocalPlayer.PlayerGui:FindFirstChild("ProximityPrompts")
    ...
    local ActionTextLabel = PromptFrame and PromptFrame:FindFirstChild("ActionText")
...
local AutoAddXPToggle = EventTab2:Toggle({
    Title = "Auto Add XP",
...
local AutoResetToggle = EventTab2:Toggle({
    Title = "Auto Reset Request",
